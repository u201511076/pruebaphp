			...
			if($result > 0){
				...
				if(empty($_POST['clave']))
				{
					...
					$sql_update = mysqli_query($conection,"UPDATE usuario
															SET nombre = '$nombre', apellido='$apellido',correo='$email',usuario='$user',rol='$rol' ,user_mod='$usermod',cpc_mod='$rootmod'
													
															WHERE idusuario= $idUsuario  ");
				}else{
					$sql_update = mysqli_query($conection,"UPDATE usuario
															SET nombre = '$nombre', correo='$email',usuario='$user',clave='$clave', rol='$rol' ,
															    user_mod='$usermod',cpc_mod='$rootmod'
															WHERE idusuario= $idUsuario ");
	...
	<section id="container">
		...
		<div class="form_register">
			...
			<form action="" method="post">
				...
				<input type="text" name="apellido" id="apellido" placeholder="Apellido del Usuario" value="<?php echo $apellido; ?>">
