...
<body>
	...
	<section id="container">
		...
		<?php 
			...
			$query = mysqli_query($conection,"SELECT u.idusuario, u.nombre,u.apellido,u.correo, u.usuario, r.rol FROM usuario u INNER JOIN rol r ON u.rol = r.idrol ORDER BY u.idusuario ASC LIMIT $desde,$por_pagina 
				");
